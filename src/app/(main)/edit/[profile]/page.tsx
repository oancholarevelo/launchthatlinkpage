...
import { ChevronsLeft, Save, Link as LinkIcon, Plus, Trash2, User, Copy, Palette, UploadCloud, Loader2, CheckCircle, XCircle, Star, Users, QrCode } from 'lucide-react';
        ...
        <div className="bg-white/50 border border-slate-200/50 rounded-xl shadow-md backdrop-blur-lg p-6 mb-8">
          ...
          <div className="mt-4 border-t border-slate-200/80 pt-4">
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <button onClick={handleCopyToClipboard} className="p-2.5 inline-flex items-center justify-center text-sm font-semibold rounded-lg bg-slate-600 text-white hover:bg-slate-700 shadow-sm transition-all" title="Copy Link">
                  <Copy size={16}/>
              </button>
              <button 
                onClick={() => setIsQrModalOpen(true)} 
                disabled={!username || usernameStatus === 'taken' || usernameStatus === 'invalid'}
                className="p-2.5 inline-flex items-center justify-center text-sm font-semibold rounded-lg bg-slate-600 text-white hover:bg-slate-700 shadow-sm transition-all disabled:bg-slate-300 disabled:cursor-not-allowed"
